...
public class HttpHeadersParserTest {
    ...
    public void testMultipleHeaders() throws InvocationTargetException, IllegalAccessException {
        ...
        parseHeadersMethod.invoke(
                ...
                request);
        assertEquals(16, request.getHeaderNames().size());
        assertEquals("localhost:8080", request.getHeader("host"));
    }

    //Test for white space before the colon on the http header
    @Test
    public void testErrorSpaceBeforeColonHeader() throws InvocationTargetException, IllegalAccessException {
        ...
        try {
            parseHeadersMethod.invoke(
                    httpParser,
                    generateSpaceBeforeErrorHeaderMessage(),
                    request);
...
//                        "\r\n";
    ...
    //Test generator for multiple headers
    ...
    // test for a space before the colon
    private InputStreamReader generateSpaceBeforeErrorHeaderMessage(){
        String rawData =  "Host : localhost:8080\r\n\r\n" + //note the additional whitespace before colon on header
                "Connection: keep-alive\r\n" +
                "Cache-Control: max-age=0\r\n" +
                "sec-ch-ua: \"Brave\";v=\"131\", \"Chromium\";v=\"131\", \"Not_A Brand\";v=\"24\"\r\n" +
                "sec-ch-ua-mobile: ?0\r\n" +
